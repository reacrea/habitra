...
export type ParseParamsFn<in out TPath extends string, in out TParams> = (rawParams: Expand<ResolveParams<TPath>>) => (TParams extends ResolveParams<TPath, any> ? TParams : ResolveParams<TPath, any>) | false;
