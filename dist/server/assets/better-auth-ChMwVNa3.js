import { n as __reExport, t as __exportAll } from "./rolldown-runtime-BYF0ZUUg.js";
import { a as isDynamicBaseURLConfig, c as wildcardMatch, i as getProtocol, n as getHost, o as isRequestLike, r as getOrigin, s as resolveBaseURL, t as getBaseURL } from "./url-CJKHUI7_.js";
...
async function getAdapter(options) {
	return getBaseAdapter(options, async (opts) => {
		const { createKyselyAdapter } = await import("./kysely-adapter-chQh01SG.js");
		...
		const { kyselyAdapter } = await import("./kysely-adapter-chQh01SG.js");
...
//#endregion
//#region node_modules/better-auth/dist/adapters/prisma-adapter/index.mjs
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("./server-DcmvO1qi.js").then((n) => n.t);
...
//#endregion
//#region src/lib/auth/better-auth.ts
var better_auth_exports = /* @__PURE__ */ __exportAll({ auth: () => auth });
var baseURL = process.env.BETTER_AUTH_URL ?? "http://localhost:3000";
var auth = betterAuth({
...
//#endregion
export { better_auth_exports as n, auth as t };
