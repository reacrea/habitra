import { t as Route } from "./rent-Bb7b8gJZ.js";
import { t as useServerFn } from "./useServerFn-B54YjcTl.js";
import { n as CrmInlineError, r as CrmLoading, t as CrmEmpty } from "./CrmStates-DncpktRG.js";
import { n as getPublicListings, r as PropertySearchBar } from "./public-b2c-BNtb2Dbk.js";
import { t as PublicLayout } from "./PublicLayout-Bnt76fW6.js";
import { useNavigate } from "@tanstack/react-router";
import { useQuery } from "@tanstack/react-query";
import { jsxDEV } from "react/jsx-dev-runtime";
//#region src/routes/rent.tsx?tsr-split=component
var _jsxFileName = "C:/Jcrea/Projects/Habitra/src/routes/rent.tsx?tsr-split=component";
function RentPage() {
	const search = Route.useSearch();
	const navigate = useNavigate();
	const fetchListings = useServerFn(getPublicListings);
	const query = useQuery({
		queryKey: ["public-rent-listings", search],
	...
	return /* @__PURE__ */ jsxDEV(PublicLayout, { children: /* @__PURE__ */ jsxDEV("section", {
		...
		children: [
			...
			query.isError ? /* @__PURE__ */ jsxDEV(CrmInlineError, { message: "No se pudieron cargar propiedades en renta." }, void 0, false, {
				fileName: _jsxFileName,
				lineNumber: 40,
				columnNumber: 26
			}, this) : null,
