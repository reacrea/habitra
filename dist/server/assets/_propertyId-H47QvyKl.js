...
import { t as Route } from "./_propertyId-DSj_OuqK.js";
...
import { c as PROPERTY_STATUS_LABELS, l as PROPERTY_TYPE_LABELS, n as DOCUMENT_STATUS_LABELS, r as DOCUMENT_TYPE_LABELS, s as OPERATION_TYPE_LABELS } from "./crm-labels-DF9xqjOX.js";
import { i as propertyDocumentCreateSchema } from "./document-ByUETWWA.js";
import { i as propertyUpdateSchema } from "./property-CPXLTy2i.js";
import { n as createPropertyDocument, o as updateProperty, r as getPropertyDetail, s as updatePropertyChecklist, t as addPropertyImage } from "./properties-crud-DJ72vQKB.js";
import { r as listSellerOptions } from "./sellers-crud-nJ3oVoRF.js";
...
var _jsxFileName$3 = "C:/Jcrea/Projects/Habitra/src/components/crm/properties/PropertyCrmOverview.tsx";
...
//#endregion
//#region src/components/crm/properties/PropertyDocumentsSection.tsx
var _jsxFileName$2 = "C:/Jcrea/Projects/Habitra/src/components/crm/properties/PropertyDocumentsSection.tsx";
/** URL de ejemplo válida (PDF público de prueba W3C). */
var EXAMPLE_DOC_URL = "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf";
function PropertyDocumentsSection({ propertyId, documents, canEdit }) {
	...
	useEffect(() => {
		...
		const t = setTimeout(() => setSuccessMsg(null), 4e3);
		return () => clearTimeout(t);
	}, [successMsg]);
	const mutation = useMutation({
		mutationFn: () => createFn({ data: propertyDocumentCreateSchema.parse({
			propertyId,
			title: form.title,
			type: form.type,
			status: form.status,
	...
	return /* @__PURE__ */ jsxDEV("section", {
		...
		children: [
			...
			successMsg ? /* @__PURE__ */ jsxDEV("p", {
				className: "mb-3 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-2 text-sm text-emerald-900",
				children: successMsg
			}, void 0, false, {
				fileName: _jsxFileName$2,
				lineNumber: 95,
			...
			documents.length === 0 ? /* @__PURE__ */ jsxDEV("div", {
				className: "rounded-xl border border-dashed border-slate-300 bg-slate-50/80 px-4 py-8 text-center",
				children: [/* @__PURE__ */ jsxDEV("p", {
					className: "text-sm font-medium text-slate-700",
					children: "Aún no hay documentos en esta propiedad"
				}, void 0, false, {
					fileName: _jsxFileName$2,
					lineNumber: 102,
					columnNumber: 11
					...
					children: canEdit ? "Usa \"Subir documento\" para registrar un archivo (URL) y vincularlo al inmueble." : "Los documentos cargados por el equipo aparecerán aquí."
				}, void 0, false, {
					fileName: _jsxFileName$2,
					lineNumber: 103,
					columnNumber: 11
				...
				children: documents.map((doc) => /* @__PURE__ */ jsxDEV("li", {
					...
					children: [
						...
						doc.description ? /* @__PURE__ */ jsxDEV("p", {
			...
			modalOpen ? /* @__PURE__ */ jsxDEV("div", {
				...
				children: [/* @__PURE__ */ jsxDEV("button", {
					...
					children: [
						/* @__PURE__ */ jsxDEV("h4", {
							id: "property-doc-modal-title",
							className: "text-lg font-semibold text-habitra-text",
							children: "Nuevo documento en la propiedad"
						}, void 0, false, {
							fileName: _jsxFileName$2,
							lineNumber: 153,
							columnNumber: 13
						...
						/* @__PURE__ */ jsxDEV("p", {
							...
							children: "El archivo debe estar accesible por URL (almacenamiento externo o enlace de prueba)."
						}, void 0, false, {
							fileName: _jsxFileName$2,
							lineNumber: 156,
							columnNumber: 13
						...
						/* @__PURE__ */ jsxDEV("div", {
							...
							children: [
								/* @__PURE__ */ jsxDEV("label", {
									...
									children: ["Tipo", /* @__PURE__ */ jsxDEV("select", {
								...
								/* @__PURE__ */ jsxDEV("label", {
									className: "block text-sm text-slate-700",
									children: ["Nombre / titulo", /* @__PURE__ */ jsxDEV("input", {
										className: inputClass,
										value: form.title,
										onChange: (e) => setForm((f) => ({
											...f,
								...
								/* @__PURE__ */ jsxDEV("label", {
									...
									children: [
										...
										/* @__PURE__ */ jsxDEV("button", {
											...
											onClick: () => setForm((f) => ({
												...f,
												fileUrl: EXAMPLE_DOC_URL
											})),
											children: "Usar URL de ejemplo (PDF de prueba)"
										}, void 0, false, {
											fileName: _jsxFileName$2,
											lineNumber: 192,
											columnNumber: 17
								...
								/* @__PURE__ */ jsxDEV("label", {
									className: "block text-sm text-slate-700",
									children: ["Nombre de archivo (opcional)", /* @__PURE__ */ jsxDEV("input", {
										className: inputClass,
										value: form.fileName,
										onChange: (e) => setForm((f) => ({
											...f,
								...
								/* @__PURE__ */ jsxDEV("label", {
									className: "block text-sm text-slate-700",
									children: ["Estatus inicial", /* @__PURE__ */ jsxDEV("select", {
										className: inputClass,
										value: form.status,
										onChange: (e) => setForm((f) => ({
											...f,
								...
								/* @__PURE__ */ jsxDEV("label", {
									className: "block text-sm text-slate-700",
									children: ["Comentarios", /* @__PURE__ */ jsxDEV("textarea", {
						...
						/* @__PURE__ */ jsxDEV("div", {
							...
							children: [/* @__PURE__ */ jsxDEV("button", {
								...
								children: mutation.isPending ? "Guardando..." : "Guardar documento"
							}, void 0, false, {
								fileName: _jsxFileName$2,
								lineNumber: 243,
								columnNumber: 15
...
function PropertyDetailPage() {
	...
	return /* @__PURE__ */ jsxDEV("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxDEV(PropertyDocumentsSection, {
				propertyId,
				documents,
				canEdit: canEditProperty
			}, void 0, false, {
