...
import { t as buildAiDummyInsights } from "./ai-dummy-B1BobnKK.js";
import { n as buyerPortalTransactionIdSchema, t as buyerPortalProfileUpdateSchema } from "./buyer-portal-BrjxntV8.js";
...
var updateBuyerProfileData = createServerFn({ method: "POST" }).inputValidator((data) => buyerPortalProfileUpdateSchema.parse(data)).handler(updateBuyerProfileData_createServerFn_handler, async ({ data }) => {
	...
	const updated = await prisma.buyer.update({
		...
		data: {
			...
			...data.desiredZone !== void 0 ? { desiredZone: data.desiredZone || null } : {},
