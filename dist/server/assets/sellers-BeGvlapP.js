...
import { a as applySellerColumnFilters, c as useCrmColumnFilters } from "./crm-column-filter-apply-CmPhgmdh.js";
import { i as listSellers } from "./sellers-crud-nJ3oVoRF.js";
			...
			children: [/* @__PURE__ */ jsxDEV("thead", {
				...
				children: sellers.length === 0 ? /* @__PURE__ */ jsxDEV("tr", { children: /* @__PURE__ */ jsxDEV("td", {
					...
					children: [
						...
						/* @__PURE__ */ jsxDEV("td", {
							className: "px-4 py-3 text-center tabular-nums text-slate-700",
							children: seller.propertyCount ?? 0
						}, void 0, false, {
							fileName: _jsxFileName$1,
							lineNumber: 79,
							columnNumber: 17
