...
import { c as useCrmColumnFilters, n as applyDocumentColumnFilters } from "./crm-column-filter-apply-CmPhgmdh.js";
			...
			children: [/* @__PURE__ */ jsxDEV("thead", {
				...
				children: documents.length === 0 ? /* @__PURE__ */ jsxDEV("tr", { children: /* @__PURE__ */ jsxDEV("td", {
					...
					/* @__PURE__ */ jsxDEV("td", {
						...
						children: d.propertyId ? /* @__PURE__ */ jsxDEV(Link, {
							to: "/app/properties/$propertyId",
							params: { propertyId: d.propertyId },
							className: "font-medium text-emerald-700 hover:underline",
							children: (d.propertyTitle ?? "").trim() || "Ver propiedad"
						}, void 0, false, {
							fileName: _jsxFileName$1,
							lineNumber: 86,
							columnNumber: 21
