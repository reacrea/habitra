  ...
  return (
    <PublicLayout>
      <section className="mx-auto max-w-7xl space-y-6 px-4 py-12 md:px-6">
        <h1 className="text-3xl font-bold text-habitra-text">Propiedades en renta</h1>
        <PropertySearchBar
        ...
        {query.isError ? <CrmInlineError message="No se pudieron cargar propiedades en renta." /> : null}
